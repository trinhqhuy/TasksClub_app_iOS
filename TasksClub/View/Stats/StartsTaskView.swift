        ...
        VStack {
            HStack{
                ...
                Spacer()
                    ...
                    if self.taskmodel.StatsTaskArray.count == 0 {
                        EmptyTaskView(ImageName: "person9", TextContent: "Hãy đánh dấu công việc")
                    } else {
                        ForEach(self.taskmodel.StatsTaskArray){ task in
                            VStack {
                                HStack {
...
struct StartsTaskView_Previews: PreviewProvider {
